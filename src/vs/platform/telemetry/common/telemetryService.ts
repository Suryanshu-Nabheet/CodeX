...
CodeX separately records basic usage like the number of messages people are sending. If you'd like to disable CodeX metrics, you may do so in CodeX's Settings.
`;
