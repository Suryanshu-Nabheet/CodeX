...
export abstract class AbstractUpdateService implements IUpdateService {
	...
	constructor(
		...
		@IEnvironmentMainService protected readonly environmentMainService: IEnvironmentMainService,
	...
	protected scheduleCheckForUpdates(delay = 60 * 60 * 1000): Promise<void> {
