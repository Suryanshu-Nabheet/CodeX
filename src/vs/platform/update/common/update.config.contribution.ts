...
configurationRegistry.registerConfiguration({
	...
	properties: {
		'update.mode': {
			...
			description: localize('updateMode', "Configure whether you receive automatic updates. Requires a restart after change. The updates are fetched from GitHub releases."),
		...
		'update.showReleaseNotes': {
			...
			default: true,
			scope: ConfigurationScope.APPLICATION,
			description: localize('showReleaseNotes', "Show Release Notes after an update. The Release Notes are fetched from GitHub releases."),
			tags: ['usesOnlineServices']
		}
	}
});
