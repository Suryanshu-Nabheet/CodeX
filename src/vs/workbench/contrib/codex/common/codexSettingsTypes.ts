...
import { CodexSettingsState } from './codexSettingsService.js'
...
export type CodexStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with Codex. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: CodexStatefulModelInfo[] } => {
	return {
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: CodexSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: CodexSettingsState) => {
