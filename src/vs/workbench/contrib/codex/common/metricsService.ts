...
export class MetricsService implements IMetricsService {
	...
	constructor(
		...
		this.metricsService = ProxyChannel.toService<IMetricsService>(mainProcessService.getChannel('codex-channel-metrics'));
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'codexDebugInfo',
			f1: true,
			title: localize2('codexMetricsDebug', 'Codex: Log Debug Info'),
		});
	}
