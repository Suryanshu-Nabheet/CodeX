...
export type CodexCommandBarProps = {
	uri: URI | null;
	editor: ICodeEditor;
}

export const ICodexCommandBarService = createDecorator<ICodexCommandBarService>('CodexCommandBarService');

export interface ICodexCommandBarService {
