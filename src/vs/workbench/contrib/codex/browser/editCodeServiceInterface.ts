...
import { Diff, DiffArea, CodexFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getCodexFileSnapshot(uri: URI): CodexFileSnapshot;
	restoreCodexFileSnapshot(uri: URI, snapshot: CodexFileSnapshot): void;
}
