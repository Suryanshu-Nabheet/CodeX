...
// ---------- Register viewpane inside the codex container ----------

// const codexThemeIcon = Codicon.symbolObject;
// const codexViewIcon = registerIcon('codex-view-icon', codexThemeIcon, localize('codexViewIcon', 'View icon of the Codex chat view.'));

// called VIEWLET_ID in other places for some reason
export const CODEX_VIEW_CONTAINER_ID = 'workbench.view.codex'
export const CODEX_VIEW_ID = CODEX_VIEW_CONTAINER_ID
...
// open sidebar
export const CODEX_OPEN_SIDEBAR_ACTION_ID = 'codex.openSidebar'
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupCodexSidebar';
	constructor(
		@ICommandService private readonly commandService: ICommandService,
	) {
		this.commandService.executeCommand(CODEX_OPEN_SIDEBAR_ACTION_ID)
	}
}
