...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/codex/common/codexSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { CodexSettingsState } from '../../../../../../../workbench/contrib/codex/common/codexSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/codex/common/refreshModelService.js'
...
import { ICodexCommandBarService } from '../../../codexCommandBarService.js'
...
let settingsState: CodexSettingsState
const settingsStateListeners: Set<(s: CodexSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(ICodexSettingsService),
	...
	disposables.push(
		codexCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		codexCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		ICodexSettingsService: accessor.get(ICodexSettingsService),
		...
		ICodexModelService: accessor.get(ICodexModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		ICodexCommandBarService: accessor.get(ICodexCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Codex useAccessor was called before _registerServices!`)
	}
