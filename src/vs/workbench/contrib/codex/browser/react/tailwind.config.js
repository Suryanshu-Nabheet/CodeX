	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--codex-fg-1)',
						'--tw-prose-headings': 'var(--codex-fg-1)',
						'--tw-prose-lead': 'var(--codex-fg-2)',
						'--tw-prose-links': 'var(--codex-link-color)',
						'--tw-prose-bold': 'var(--codex-fg-1)',
						'--tw-prose-counters': 'var(--codex-fg-3)',
						'--tw-prose-bullets': 'var(--codex-fg-3)',
						'--tw-prose-hr': 'var(--codex-border-4)',
						'--tw-prose-quotes': 'var(--codex-fg-1)',
						'--tw-prose-quote-borders': 'var(--codex-border-2)',
						'--tw-prose-captions': 'var(--codex-fg-3)',
						'--tw-prose-code': 'var(--codex-fg-0)',
						'--tw-prose-pre-code': 'var(--codex-fg-0)',
						'--tw-prose-pre-bg': 'var(--codex-bg-1)',
						'--tw-prose-th-borders': 'var(--codex-border-4)',
						'--tw-prose-td-borders': 'var(--codex-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'codex-bg-1': 'var(--codex-bg-1)',
				'codex-bg-1-alt': 'var(--codex-bg-1-alt)',
				'codex-bg-2': 'var(--codex-bg-2)',
				'codex-bg-2-alt': 'var(--codex-bg-2-alt)',
				'codex-bg-2-hover': 'var(--codex-bg-2-hover)',
				'codex-bg-3': 'var(--codex-bg-3)',


				'codex-fg-0': 'var(--codex-fg-0)',
				'codex-fg-1': 'var(--codex-fg-1)',
				'codex-fg-2': 'var(--codex-fg-2)',
				'codex-fg-3': 'var(--codex-fg-3)',
				// 'codex-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'codex-fg-4': 'var(--codex-fg-4)',

				'codex-warning': 'var(--codex-warning)',

				'codex-border-1': 'var(--codex-border-1)',
				'codex-border-2': 'var(--codex-border-2)',
				'codex-border-3': 'var(--codex-border-3)',
				'codex-border-4': 'var(--codex-border-4)',

				'codex-ring-color': 'var(--codex-ring-color)',
				'codex-link-color': 'var(--codex-link-color)',
