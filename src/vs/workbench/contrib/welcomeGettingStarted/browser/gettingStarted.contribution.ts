...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('miWelcome', 'Get Started with CodeX'),
			...
			metadata: {
				description: localize2('minWelcomeDescription', 'Opens the Welcome page to help you get started in CodeX.')
			}
		});
	}

	public run(accessor: ServicesAccessor, walkthroughID: string | { category: string; step: string } | undefined, optionsOrToSide: { toSide?: boolean; inactive?: boolean } | boolean | undefined) {
		openWalkthrough(accessor, walkthroughID, optionsOrToSide);
	}
});
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('miWelcome2', 'Welcome: Get Started'),
			category: Categories.Help,
			f1: true,
			metadata: {
				description: localize2('minWelcomeDescription2', 'Opens the Welcome page to help you get started in CodeX.')
			}
		});
	}

	public run(accessor: ServicesAccessor) {
		openWalkthrough(accessor, undefined, undefined);
	}
});
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('welcome.showAllWalkthroughs', 'Get Started: Open Walkthrough...'),
			category,
			f1: true,
		});
	}
	...
	properties: {
		...
		'workbench.startupEditor': {
			...
			'enumDescriptions': [
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.welcomePage' }, "Open the Welcome page, with content to aid in getting started with CodeX and extensions."),
