...
// import { CodexModeToggleContribution } from './codexModeToggle.js';
...
// registerWorkbenchContribution2(CodexModeToggleContribution.ID, CodexModeToggleContribution, WorkbenchPhase.BlockRestore);
