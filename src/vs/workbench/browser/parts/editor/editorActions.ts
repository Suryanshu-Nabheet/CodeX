	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.TitleBar, order: 2, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled'), group: 'navigation' }
			]
		});
	}
	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.TitleBar, order: 1, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled'), group: 'navigation' }
			]
		});
	}
