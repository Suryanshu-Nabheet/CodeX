...
export interface IPaneCompositePart extends IView {
	...
	/**
	 * Returns the position of the composite bar.
	 */
	getCompositeBarPosition(): CompositeBarPosition;
}
...
export abstract class AbstractPaneCompositePart extends CompositePart<PaneComposite> implements IPaneCompositePart {
	...
	protected override createTitleLabel(parent: HTMLElement): ICompositeTitleLabel {
		...
		this._register(CompositeDragAndDropObserver.INSTANCE.registerDraggable(this.titleLabelElement!, draggedItemProvider, {
			canDrag: () => this.location !== ViewContainerLocation.AuxiliaryBar
		}));

		return titleLabel;
	}

	private updateTitleDraggability(): void {
		if (this.titleLabelElement) {
			this.titleLabelElement.draggable = this.location !== ViewContainerLocation.AuxiliaryBar;
		}
	}
	...
	public abstract getCompositeBarPosition(): CompositeBarPosition;
}
