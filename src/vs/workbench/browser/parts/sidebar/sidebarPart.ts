...
export class SidebarPart extends AbstractPaneCompositePart {
	...
	protected getCompositeBarOptions(): IPaneCompositeBarOptions {
		return {
			...
			compact: true,
			maxVisibleItems: (this.getCompositeBarPosition() === CompositeBarPosition.TOP || this.getCompositeBarPosition() === CompositeBarPosition.BOTTOM) ? 4 : undefined
		};
	}
