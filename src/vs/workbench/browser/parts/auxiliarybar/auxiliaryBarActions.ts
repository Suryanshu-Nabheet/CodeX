...
export class ToggleAuxiliaryBarAction extends Action2 {
	...
	static readonly LABEL = localize2('toggleAuxiliaryBar', "Toggle CodeX Side Bar Visibility");
	...
	constructor() {
		super({
			...
			toggled: {
				...
				title: localize('closeSecondarySideBar', 'Hide CodeX Side Bar'),
				icon: closeIcon,
			...
			metadata: {
				description: localize('openAndCloseAuxiliaryBar', 'Open/Show and Close/Hide CodeX Side Bar'),
			},
			f1: true,
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('closeSecondarySideBar', 'Hide CodeX Side Bar'),
			category: Categories.View,
...
registerAction2(class FocusAuxiliaryBarAction extends Action2 {
	...
	static readonly LABEL = localize2('focusAuxiliaryBar', "Focus into CodeX Side Bar");
...
MenuRegistry.appendMenuItems([
	{
		...
		item: {
			...
			command: {
				id: ToggleAuxiliaryBarAction.ID,
				title: localize('toggleSecondarySideBar', "Toggle CodeX Side Bar"),
		...
		item: {
			...
			command: {
				id: ToggleAuxiliaryBarAction.ID,
				title: localize2('hideAuxiliaryBar', 'Hide CodeX Side Bar'),
			},
...
registerAction2(class extends SwitchCompositeViewAction {
	constructor() {
		super({
			...
			title: localize2('previousAuxiliaryBarView', 'Previous CodeX Side Bar View'),
			category: Categories.View,
			f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
	constructor() {
		super({
			...
			title: localize2('nextAuxiliaryBarView', 'Next CodeX Side Bar View'),
			category: Categories.View,
			f1: true
		}, ViewContainerLocation.AuxiliaryBar, 1);
	}
