...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	private createGridDescriptor(): ISerializedGrid {
		...
		type StartupLayoutEventClassification = {
			...
			auxiliaryBarVisible: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'Whether or the not the CodeX side bar is visible' };
...
const LayoutStateKeys = {
	...
	AUXILIARYBAR_SIZE: new InitializationStateKey<number>('auxiliaryBar.size', StorageScope.PROFILE, StorageTarget.MACHINE, 800), // CodeX changed this from 200 to 800
