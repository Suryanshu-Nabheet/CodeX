	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'workbench.sideBar.location': {
				...
				'enum': ['left', 'right'],
				'default': 'left',
				'description': localize('sideBarLocation', "Controls the location of the primary side bar and activity bar. They can either show on the left or right of the workbench. The CodeX side bar will show on the opposite side of the workbench.")
			},
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				...
				'default': 'default',
				'markdownDescription': localize({ comment: ['This is the description for a setting'], key: 'activityBarLocation' }, "Controls the location of the Activity Bar relative to the Primary and CodeX Side Bars."), // CodeX side bar
				'enumDescriptions': [
					localize('workbench.activityBar.location.default', "Show the Activity Bar on the side of the Primary Side Bar and on top of the CodeX Side Bar."), // CodeX side bar
					localize('workbench.activityBar.location.top', "Show the Activity Bar on top of the Primary and CodeX Side Bars."), // CodeX side bar
					localize('workbench.activityBar.location.bottom', "Show the Activity Bar at the bottom of the Primary and CodeX Side Bars."), // CodeX side bar
					localize('workbench.activityBar.location.hide', "Hide the Activity Bar in the Primary and CodeX Side Bars.") // CodeX side bar
				],
			},
			...
			'workbench.hover.delay': {
				...
				'default': 300, // CodeX changed this from isMacintosh ? 1500 : 500,
				'minimum': 0
			},
	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'window.confirmBeforeClose': {
				...
				'default': 'always', // CodeX: enabled by default
				'markdownDescription': isWeb ?
