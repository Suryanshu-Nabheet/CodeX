...
// Chat
// CodeX - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
...
import './contrib/onboarding/onboarding.contribution.js';

// Codex
import './contrib/codex/browser/codex.contribution.js';
