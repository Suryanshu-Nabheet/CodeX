...
interface ExtensionConfigType {
	...
	enabled: boolean;
	/**
	 * When enabled - extension will take into account global CodeX setting `#problems.visibility#`.
	 */
	...
	/**
	 * Replaces `$severity` variable in `#codexErrorLens.messageTemplate#`.
	 */
	severityText: string[];
	/**
	...
	/**
	 * Which problem to select when running `codexErrorLens.selectProblem` command.
	 */
	...
	/**
	 * See `#codexErrorLens.messageTemplate#`.
	 */
	...
	/**
	 * When `#codexErrorLens.onSave#` enabled - extension still draws decorations when active/visible editors change.
	 */
	...
	/**
	 * Symbol to replace linebreaks. Requires enabling `#codexErrorLens.removeLinebreaks#`.
	 */
	...
	/**
	 * When enabled and `#codexErrorLens.followCursor#` setting is not `allLines`, then gutter icons would be rendered for all problems.
	...
	/**
	 * Pick emoji symbol for gutter icon when `#codexErrorLens.gutterIconSet#` is `emoji`.
	 */
	gutterEmoji: {
		error: string;
		warning: string;
	...
	ignoreDirty: boolean;
	/**
	 * Controls whether to show the CodeX Error Lens as a Code Lens above the code.
	 */
	...
	/**
	 * Controls what do on clicking the `#codexErrorLens.codeLensEnabled#`
	 */
...
export const enum Constants {
	 ...
	 */
	ExtensionId = 'codex.codex-error-lens',
	/**
	 * Prefix used for all settings of this extension.
	 */
	SettingsPrefix = 'codexErrorLens',
	/**
	 * Command id of CodeX command to show problems view.
	 */
	OpenProblemsViewCommandId = 'workbench.actions.view.problems',
	/**
	 * Command id of CodeX show quick fix menu in editor.
	 */
	QuickFixCommandId = 'editor.action.quickFix',
	/**
	 * Command id of CodeX command to focus active editor group.
	 */
	FocusActiveEditorCommandId = 'workbench.action.focusActiveEditorGroup',
	/**
	 * Command id of CodeX command to open next problem marker.
	 */
