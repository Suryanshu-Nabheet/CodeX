...
import { getStyleForAlignment } from './decorations/align';
import { $config, $state } from './extension';
import { doUpdateGutterDecorations, getGutterStyles, updateWorkaroundGutterIcon, type Gutter } from './gutter';
import { createHoverForDiagnostic } from './hover/hover';
import { disposeTransmutedDecorations, doUpdateTransmutedDecorations, setTransmutedDecorationStyle, transmute } from './transmute';
import { extUtils, type GroupedByLineDiagnostics } from './utils/extUtils';
...
export function setDecorationStyle(context: ExtensionContext): void {
	...
	let errorBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.errorBackground');
	let errorBackgroundLight: ThemeColor | undefined = new ThemeColor('codexErrorLens.errorBackgroundLight');
	const errorForeground = new ThemeColor('codexErrorLens.errorForeground');
	const errorForegroundLight = new ThemeColor('codexErrorLens.errorForegroundLight');
	let errorMessageBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.errorMessageBackground');

	let warningBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.warningBackground');
	let warningBackgroundLight: ThemeColor | undefined = new ThemeColor('codexErrorLens.warningBackgroundLight');
	const warningForeground = new ThemeColor('codexErrorLens.warningForeground');
	const warningForegroundLight = new ThemeColor('codexErrorLens.warningForegroundLight');
	let warningMessageBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.warningMessageBackground');

	let infoBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.infoBackground');
	let infoBackgroundLight: ThemeColor | undefined = new ThemeColor('codexErrorLens.infoBackgroundLight');
	const infoForeground = new ThemeColor('codexErrorLens.infoForeground');
	const infoForegroundLight = new ThemeColor('codexErrorLens.infoForegroundLight');
	let infoMessageBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.infoMessageBackground');

	let hintBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.hintBackground');
	let hintBackgroundLight: ThemeColor | undefined = new ThemeColor('codexErrorLens.hintBackgroundLight');
	const hintForeground = new ThemeColor('codexErrorLens.hintForeground');
	const hintForegroundLight = new ThemeColor('codexErrorLens.hintForegroundLight');
	let hintMessageBackground: ThemeColor | undefined = new ThemeColor('codexErrorLens.hintMessageBackground');

	const statusBarErrorForeground = new ThemeColor('codexErrorLens.statusBarErrorForeground');
	const statusBarWarningForeground = new ThemeColor('codexErrorLens.statusBarWarningForeground');
	const statusBarInfoForeground = new ThemeColor('codexErrorLens.statusBarInfoForeground');
	const statusBarHintForeground = new ThemeColor('codexErrorLens.statusBarHintForeground');
