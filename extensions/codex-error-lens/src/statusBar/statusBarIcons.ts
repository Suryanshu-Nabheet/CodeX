...
export class StatusBarIcons {
	...
	private readonly errorForegroundThemeColor = new ThemeColor('codexErrorLens.statusBarIconErrorForeground');
	private readonly warningForegroundThemeColor = new ThemeColor('codexErrorLens.statusBarIconWarningForeground');
	...
	constructor({
		...
		this.errorStatusBarItem = window.createStatusBarItem('codexErrorLensError', statusBarAlignment, priority);
		this.errorStatusBarItem.name = 'CodeX Error Lens: Error icon';
		this.errorStatusBarItem.command = Constants.OpenProblemsViewCommandId;
		this.warningStatusBarItem = window.createStatusBarItem('codexErrorLensWarning', statusBarAlignment, priority - 1);
		this.warningStatusBarItem.name = 'CodeX Error Lens: Warning icon';
