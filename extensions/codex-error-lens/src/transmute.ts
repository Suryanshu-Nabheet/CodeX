import { decorationRenderOptions } from './decorations';
import { $config } from './extension';
import { ExtensionConfig } from './types';
import { extUtils, GroupedByLineDiagnostics } from './utils/extUtils';
...
/**
 * Change decorations according to `"codexErrorLens.transmute"` setting.
 *
...
function initTransmuteObject(transmuteConfig: ExtensionConfig['transmute']): { [k: string]: { error: any[]; warning: any[]; info: any[]; hint: any[] } } {
