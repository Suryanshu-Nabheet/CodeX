import type { ResponseFunctionToolCall } from "./responses.js";
import type {
  ExecInput,
  ExecOutputMetadata,
} from "../exec/sandbox/interface.js";
...
export function parseToolCallArguments(
  ...
  // The CodexCLI model sometimes produces a single string instead of an array.
  // Accept both shapes:
  const commandArray =
    toStringArray(cmd) ??
