...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // codex warn -> off
			...
			// codex - this should only apply to workbench/codex/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
			// 		'/*--------------------------------------------------------------------------------------',
			// 		'*  Copyright CodeX. All rights reserved.',
			// 		'*  Licensed under the MIT, Version 2.0. See LICENSE.txt for more information.',
			// 		'*--------------------------------------------------------------------------------------*/',
			// 	]
			// ]
		},
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- codex
			'@stylistic/ts/member-delimiter-style': 'off', // <-- codex
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- codex
		}
	},
	// vscode TS
	{
